...
class CarouselAdapter(private val items: List<CarouselItem>, private val onItemClickListener: OnItemClickListener) : RecyclerView.Adapter<CarouselAdapter.CarouselViewHolder>() {
